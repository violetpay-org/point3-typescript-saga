...
export class SagaBuilder<Tx extends TransactionContext> {
...
export class StepBuilder<Tx extends TransactionContext>
    extends SagaBuilder<Tx>
    implements stepBuilder.IStepBuilder<Tx>
{
...
class InvokableStepBuilder<Tx extends TransactionContext>
    extends StepBuilder<Tx>
    implements
...
{
    constructor(sagaBuilder: SagaBuilder<Tx>, currentStep: planning.Step<Tx>) {
        super();
        return this.loadSteps(sagaBuilder, currentStep);
    }

    private loadSteps(sagaBuilder: SagaBuilder<Tx>, currentStep: planning.Step<Tx>): InvokableStepBuilder<Tx> {
    ...
    public localInvoke(
        endpoint: endpoint.LocalEndpoint<session.SagaSession, endpoint.Response, endpoint.Response, Tx>,
